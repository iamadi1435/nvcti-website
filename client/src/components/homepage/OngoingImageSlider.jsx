...
const OngoingImageSlider = ({ title, ongoing, lazy }) => {
  ...
  return (
    <div className="word-section slider justify-align-center">
      ...
      <Container>
        {typeof ongoing !== 'undefined' && ongoing && ongoing.length !== 0 ? (
          <Fade>
            <OwlCarousel
              id="carousel"
              ...
              animateIn="ease-in"
            >
              {ongoing.map((item, ind) => {
                return (
                  <Link to={'/ongoing-events'} style={{ height: '100%' }} key={item + ind}>
...
export default connect(mapStateToProps, null)(OngoingImageSlider)
